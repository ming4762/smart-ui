...
export default class CommonUtils {
    ...
    /**
     * 开启/关闭全屏
     * @param full true 开启  / false 关闭
     */
    public static fullScreen (full: boolean) {
        if (full) {
            this.inFullScreen()
        } else {
            this.exitFullscreen()
     ...
     * @param href
     */
    private static doLoadCSS(href: string): Promise<any> {
        return new Promise<any>((resolve) => {
     ...
     * @param cssText
     */
    public static addCSS (cssText: string) {
        // 创建一个style元素
